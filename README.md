...
|------|--------|------------------|----------------|  
| [See videos to learn how to write hello world github repository](https://www.bing.com/videos/search?q=how+to+write+hello+world+github+repository&qpvt=how+to+write+hello+world+github+repository&FORM=VDRE) | GitHub Guides | 2 | Visual make it more easy to understand |
